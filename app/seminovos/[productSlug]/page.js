      ...
      <div className="page-container">
        <div className="product-container">
          ...
          <div className="doubt-card">
            ...
            <ProductWhatsappButton link={`https://wa.me/${productData.item_unit.phone.replace(/[^A-Z0-9]/ig, "")}?text=Olá, tenho uma pergunta sobre o veículo ${productData.name}`} />
          </div>
        </div>
